...
def analyze_for_path(path, id):
    f = h5py.File(path, 'r')
    im, scaled_coords, triangle_coords = create_permeability_map(f, (610,450))
...
def dry_spot_analysis(path, id, perm_map=None):
    ...
    output_dir = Path(r'/home/schroeter/Desktop/shape_detection%d' % id)
...
if __name__ == "__main__":
    perm0 = analyze_for_path('/home/schroeter/Desktop/2019-07-23_15-38-08_1_RESULT.erfh5',0)
    perm1 = analyze_for_path('/home/schroeter/Desktop/2019-07-23_15-38-08_7_RESULT.erfh5',1)
    perm2 = analyze_for_path('/home/schroeter/Desktop/2019-08-24_11-51-48_3_RESULT.erfh5',2)
    dry_spot_analysis('/home/schroeter/Desktop/2019-07-23_15-38-08_1_RESULT.erfh5',0, perm0)
    dry_spot_analysis('/home/schroeter/Desktop/2019-07-23_15-38-08_7_RESULT.erfh5',1, perm1)
    dry_spot_analysis('/home/schroeter/Desktop/2019-08-24_11-51-48_3_RESULT.erfh5',2, perm2)
