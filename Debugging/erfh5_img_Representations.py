...
def create_images_for_file(filename,
                           main_folder="/run/user/1002/gvfs/smb-share:server=137.250.170.56,share=home/s/c/schroeni/Data/Images_Debug/"):
...
if __name__ == "__main__":
    create_images_for_file(
        "/run/user/1002/gvfs/smb-share:server=137.250.170.56,share=share/data/RTM/Lautern/output/with_shapes/2019-04-23_10-23-20_200p/91/2019-04-23_10-23-20_91_RESULT.erfh5")
