...
if __name__ == "__main__":
    ...
    checkpoint_path to the SensorDeconvToDryspotEfficient2 Model.
    """
    ...
    m = ModelTrainer(
        lambda: SensorDeconvToDryspotEfficient2(
            ...
            checkpoint_path=Path("/cfs/share/data/RTM/Leoben/reference_datasets_torch/SensorToFlowFront/2020-04-06_10-14-02/checkpoint.pth"),
            freeze_nlayers=8),
