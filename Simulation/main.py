...
if __name__== "__main__":
    ...
    for batch_num in range(n_batches):
        sc = sc.SimCreator(perturbation_factors, initial_timestamp=initial_timestamp, count=count, batch_num=batch_num, run_on_cluster=False, overall_count=overall_count)
        t00 = time.time()
