...
def select_per_object(obj, variable, comparison_operator, value):
    if hasattr(obj, str(variable)):
        ...
        # Metadata-queries
        if variable == "path_meta" and comparison_operator == "=":
            return obj
            ...
            return obj
        # Result-queries
        elif variable == "path_result" and comparison_operator == "=":
            return obj
...
class HDF5DBToolbox:
    ...
    def add_object(self, _object):
        if _object is not None:
            self.hdf5_object_list.append(_object)
    ...
    def select(self, variable, comparison_operator, value):
        ...
        for i in range(len(self.hdf5_object_list)):
            ...
            my_comparison_operator.append(comparison_operator)

        for (a, b, c, d) in zip(
                self.hdf5_object_list, my_variable, my_comparison_operator, my_value
        ):
            selected.append(select_per_object(a, b, c, d))
