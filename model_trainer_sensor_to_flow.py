...
class SensorTrainer:
    ...
    def create_datagenerator(self, test_mode=True):
        try:
    ...
    def inference_on_test_set(self, path):
        ...
        self.test_data_generator = self.create_datagenerator(test_mode=True)
    ...
    def run_training(self):
        ...
        self.training_data_generator = self.create_datagenerator(test_mode=False)
