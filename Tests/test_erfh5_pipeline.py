    ...
    def setUp(self):
        ...
        for i in range(100):
            self.cached_files.append(
                self.p / Path(f'{i}/2019-07-11_15-14-48_{i}_RESULT.erfh5'))
...
class Test_dataset_split(unittest.TestCase):
    ...
    def test_test_set(self):
        self.assertEqual(self.num_test_samples,
                         len(self.generator.get_test_samples()))

    def test_validation_set(self):
        self.assertEqual(self.num_validation_samples,
                         len(self.generator.get_validation_samples()))
